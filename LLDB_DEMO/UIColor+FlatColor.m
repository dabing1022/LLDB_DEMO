...
+ (UIColor *)randomColor {
    NSArray *colors = @[[[self class] flatTurquoiseColor],
                        [[self class] flatGreenSeaColor],
                        [[self class] flatGreenSeaColor],
                        [[self class] flatNephritisColor],
                        [[self class] flatPeterRiverColor],
                        [[self class] flatBelizeHoleColor],
                        [[self class] flatAmethystColor],
                        [[self class] flatWisteriaColor],
                        [[self class] flatWetAsphaltColor],
                        [[self class] flatMidnightBlueColor],
                        [[self class] flatSunFlowerColor],
                        [[self class] flatOrangeColor],
                        [[self class] flatOrangeColor],
                        [[self class] flatCarrotColor],
                        [[self class] flatPumpkinColor],
                        [[self class] flatAlizarinColor],
                        [[self class] flatPomegranateColor],
                        [[self class] flatCloudsColor],
                        [[self class] flatConcreteColor],
                        [[self class] flatAsbestosColor]];
